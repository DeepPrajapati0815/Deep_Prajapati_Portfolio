...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "deepprajapati0815@gmail.com",
    href: "mailto:deepprajapati0815@gmail.com",
    color: "primary"
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/deep-prajapati-5846a71b4/",
    color: "teal"
  },
  {
    icon: Github,
    label: "GitHub",
    value: "View my work",
    href: "https://github.com/DeepPrajapati0815",
    color: "orange"
  }
];
...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const publicKey = import.meta.env.VITE_EMAILJS_EMAIL_KEY;
            ...
            <Card className="p-6 bg-gradient-card border-card-border">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <a href="mailto:deepprajapati0815@gmail.com">
